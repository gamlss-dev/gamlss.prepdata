...
1. Understanding the **Variables** in the Dataset: One of the first steps is to understand the variables in your data. This includes summarizing the variables in the data, checking their distributions, and identifying the type of each variable (e.g., categorical, continuous).
	
2. **Missing** Values; Knowing which variables have missing observations and how many observations are missing is important at this stage for decisions have to made on how to deal with the problem and whether we require  multiple imputations.  
...
```
For examples using the functions of the package see [`information`](https://mstasinopoulos.github.io/Functions-from-packages/) about the package.

## Functions

Some of the functions for manipulation of variables are;
...
| `data_navars()`          | Make variables have NA's  to numerics  |

Some of the function for graphics are;
...
| `data_association()`| measures of association between variables.           |
